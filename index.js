...
// GANTI DENGAN TOKEN ASLI DARI BOTFATHER ANDA JIKA INGIN DIJALANKAN
...
app.post("/", async (req, res) => {
    ...
    if (update.message) {
        ...
        if (msg.text && (msg.text.startsWith("/start") || msg.text === "Kembali")) {
            ...
            // TAMPILAN MENU UTAMA (Sesuai gambar contoh Anda)
            const pesanMenu = 
...
• Jangan spam 😉`;
        ...
        // 4. KETIKA USER MENGIRIM KODE MANUAL (Bukan file)
